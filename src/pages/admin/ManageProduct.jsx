      ...
      <div className="col-lg-4 col-md-6">
        ...
        <div className="product product--card">
            ...
            <div className="prod_option">
              ...
              <div className="options dropdown-menu" aria-labelledby="drop2">
                <ul>
                  ...
                  <li>
                    <a href="#test" data-toggle="modal" data-target="#myModal2" className="delete">
          ...
          <div className="product-desc">
            ...
            <p>
              Nunc placerat mi id nisi interdum mollis. Praesent pharetra, justo ut scelerisque the
              mattis, leo quam aliquet congue.
            </p>
          </div>
          {/* end /.product-desc */}
